        ...
        setTimeout(() => {
            ...
            if (container) {
                ...
                adminBanner.innerHTML = `
                    <div style="background-color: var(--simpsons-panel); color: var(--simpsons-black); padding: 15px; text-align: center; margin-bottom: 20px; border-radius: 15px; font-size: 16px; border: 4px solid var(--simpsons-yellow); box-shadow: 0 6px 10px var(--simpsons-shadow);">
                        <strong style="color: var(--simpsons-blue); font-size: 18px;">ADMIN VIEW:</strong> You are viewing <span style="color: var(--simpsons-blue); font-weight: bold;">${viewAsUserEmail}'s</span> dashboard. 
                        <div style="margin-top: 15px; display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
                            <button onclick="adminImportTown('${viewAsUserEmail}')" style="background-color: var(--simpsons-blue); color: white; border: none; padding: 8px 15px; border-radius: 10px; cursor: pointer; font-weight: bold; box-shadow: 0 4px 0 #2A4B85; position: relative; transition: all 0.2s ease;">
                                <i class="fas fa-file-upload"></i> Import Town
                            </button>
                            <button onclick="adminExportTown('${viewAsUserEmail}')" style="background-color: var(--simpsons-blue); color: white; border: none; padding: 8px 15px; border-radius: 10px; cursor: pointer; font-weight: bold; box-shadow: 0 4px 0 #2A4B85; position: relative; transition: all 0.2s ease;">
                                <i class="fas fa-file-download"></i> Export Town
                            </button>
                            <button onclick="adminOpenCurrencyModal('${viewAsUserEmail}')" style="background-color: var(--simpsons-blue); color: white; border: none; padding: 8px 15px; border-radius: 10px; cursor: pointer; font-weight: bold; box-shadow: 0 4px 0 #2A4B85; position: relative; transition: all 0.2s ease;">
                                <i class="fas fa-coins"></i> Edit Currency
                            </button>
                            <button onclick="adminDeleteTown('${viewAsUserEmail}')" style="background-color: var(--simpsons-red); color: white; border: none; padding: 8px 15px; border-radius: 10px; cursor: pointer; font-weight: bold; box-shadow: 0 4px 0 #B92D29; position: relative; transition: all 0.2s ease;">
                                <i class="fas fa-trash-alt"></i> Delete Town
                            </button>
                        </div>
                        <button onclick="window.close()" style="margin-top: 15px; background-color: var(--simpsons-green); color: white; border: none; padding: 8px 15px; border-radius: 10px; cursor: pointer; font-weight: bold; box-shadow: 0 4px 0 #5A9F31; position: relative; transition: all 0.2s ease;">
                ...
                floatingIndicator.innerHTML = `
                    <div style="position: fixed; top: 10px; left: 10px; background-color: var(--simpsons-blue); color: white; padding: 5px 10px; border-radius: 10px; z-index: 1000; font-weight: bold; box-shadow: 0 4px 0 #2A4B85; border: 2px solid var(--simpsons-yellow);">
                        <i class="fas fa-user-shield"></i> ADMIN MODE
                    </div>
                `;
                
                // Add hover effects for all admin buttons
                document.querySelectorAll('.admin-banner button').forEach(button => {
                    button.addEventListener('mouseover', function() {
                        this.style.top = '-2px';
                        if (this.style.backgroundColor === 'var(--simpsons-blue)') {
                            this.style.boxShadow = '0 6px 0 #2A4B85';
                        } else {
                            this.style.boxShadow = '0 6px 0 #5A9F31';
                        }
                    });
                    ...
                    button.addEventListener('mouseout', function() {
                        this.style.top = '0';
                        if (this.style.backgroundColor === 'var(--simpsons-blue)') {
                            this.style.boxShadow = '0 4px 0 #2A4B85';
                        } else {
                            this.style.boxShadow = '0 4px 0 #5A9F31';
                        }
                    });
                    
                    button.addEventListener('mousedown', function() {
                        this.style.top = '4px';
                        this.style.boxShadow = '0 0 0 #2A4B85';
                    });
